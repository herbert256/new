<?php
  ...
  function padSeqCheckPalindrome ( $f, $n ) {
    ...
    if ( file_exists ( PAD . 'sequence/types/palindrome/generated.php' ) ) 
      return in_array ( $n, PADpalindrome );

    if ( file_exists ( PAD . 'sequence/types/palindrome/fixed.php' ) ) {
      $fixed = include PAD . 'sequence/types/palindrome/fixed.php';
