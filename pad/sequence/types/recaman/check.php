<?php
  ...
  function padSeqCheckRecaman ( $f, $n ) {
    ...
    if ( file_exists ( PAD . 'sequence/types/recaman/generated.php' ) ) 
      return in_array ( $n, PADrecaman );

    if ( file_exists ( PAD . 'sequence/types/recaman/fixed.php' ) ) {
      $fixed = include PAD . 'sequence/types/recaman/fixed.php';
