<?php
  ...
  function padSeqCheckKolakoski ( $f, $n ) {
    ...
    if ( file_exists ( PAD . 'sequence/types/kolakoski/generated.php' ) ) 
      return in_array ( $n, PADkolakoski );

    if ( file_exists ( PAD . 'sequence/types/kolakoski/fixed.php' ) ) {
      $fixed = include PAD . 'sequence/types/kolakoski/fixed.php';
