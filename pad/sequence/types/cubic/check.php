<?php
  ...
  function padSeqCheckCubic ( $f, $n ) {
    ...
    if ( file_exists ( PAD . 'sequence/types/cubic/generated.php' ) ) 
      return in_array ( $n, PADcubic );

    if ( file_exists ( PAD . 'sequence/types/cubic/fixed.php' ) ) {
      $fixed = include PAD . 'sequence/types/cubic/fixed.php';
