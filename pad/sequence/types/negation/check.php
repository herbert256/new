<?php
  ...
  function padSeqCheckNegation ( $f, $n ) {
    ...
    if ( file_exists ( PAD . 'sequence/types/negation/generated.php' ) ) 
      return in_array ( $n, PADnegation );

    if ( file_exists ( PAD . 'sequence/types/negation/fixed.php' ) ) {
      $fixed = include PAD . 'sequence/types/negation/fixed.php';
